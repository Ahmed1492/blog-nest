...
const Summary = () => {
  return (
    <div className="flex flex-wrap items-start gap-x-4 gap-y-5 mt-8">
      <div className="flex items-center gap-4 bg-white shadow px-7 py-6 text-sm md:text-base  rounded-lg min-w-[12rem]  md:w-[14rem] xl:w-[18rem]">
      ...
      <div className="flex items-center gap-4 bg-white shadow px-7 py-6 text-sm md:text-base  rounded-lg w-[12rem]  md:w-[14rem] xl:w-[18rem]">
